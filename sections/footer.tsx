  ...
  return (
    <footer className="bg-black text-white pt-16">
      <div className="container">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#menu" className="text-gray-300 hover:text-primary transition-colors duration-300">{t('hero_section.menu')}</a></li>
              <li><a href="#our_story" className="text-gray-300 hover:text-primary transition-colors duration-300">{t('hero_section.our_story')}</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-zinc-800 mt-12 pb-6 pt-8 flex flex-col md:flex-row justify-between items-center">
